    ...
    <main className="min-h-screen bg-[#0e0f12] text-white flex items-center justify-center p-6">
      <div className="max-w-md w-full rounded-xl border border-white/10 bg-white/5 p-6">
        ...
        {user ? (
          <>
            ...
            <a
              ...
              className="inline-flex items-center rounded-md bg-white px-4 py-2 text-sm font-medium text-black hover:bg-white/90"
            >
              Logout
            </a>
          </>
        ...
        <div className="mt-6 text-sm text-white/60">
          Tip: after signing in, go back to the homepage to continue booking.
        </div>
      </div>
    </main>
  );
