    ...
    <div className="mpx">
      ...
      <section className="hero">
        <div className="container hero-inner">
          <div className="kicker">Creator Marketplace • Preview</div>
          <div className="h1">Mauritius’ #1 TikTok Creator Marketplace</div>
        ...
        {tab==='profile' && (
          <section className="profile">
            <aside className="pf-side">
              ...
              <div style={{color:'#64748b', marginBottom:10}}>Port Louis • Fashion & Lifestyle</div>
              <div className="tier"><div><strong>Live (15 min)</strong><br/><small>Shoutout + Pin</small></div><div>Rs 5,000</div></div>
              <div className="tier"><div><strong>Review (1 video)</strong><br/><small>30–60s scripted</small></div><div>Rs 8,000</div></div>
            ...
            <section className="pf-main">
              ...
              <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(220px,1fr))',gap:10,marginTop:8}}>
                ...
                <div className="panel">Video Slot</div>
                <div className="panel">Audience • 18–24 • MU</div>
              </div>
            </section>
          </section>
        )}
          ...
          <div style={{background:'#fff',border:'1px solid #e2e8f0',width:'min(620px,92vw)',borderRadius:16,padding:16}}
            ...
            <div style={{display:'grid',gap:10}}>
              <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10}}>
                <select><option>Service • Live 15 min</option><option>Shoutout</option><option>Collab Pack</option></select>
                <input type="date"/>
              </div>
              <textarea rows={4} placeholder="Campaign details…"></textarea>
              <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10}}>
